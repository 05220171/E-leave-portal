...
<div class="container mt-4">
    ...
    @else
        <h3 class="mb-3 mt-4" style="font-weight: 600; color: #28a745;"> {{-- Green color for "Approved" title --}}
            <i class="fas fa-check-double me-2"></i> Leaves Approved by You
        </h3>
                ...
                <tbody>
                    @foreach($approvedLeaves as $index => $leave)
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="status-badge status-approved"> {{-- Status will be approved here --}}
...
{{-- This @section('css') would be REDUNDANT if you moved the styles to a global CSS file --}}
{{-- @section('css')
    <style>
